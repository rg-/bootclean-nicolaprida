...
<div id="<?php echo $section['section_id']; ?>" class="bg-<?php echo $section['section_style_background']; ?> text-<?php echo $section['section_style_color']; ?>">
	...
	<?php
		...
		if($content_side == 'right'){
			$content_class = 'gpx-2 gpr-lg-0 gpl-lg-3 gpt-2 gpt-md-6 gpb-2 gpb-md-4 text-center text-md-left';
		}
		if($content_side == 'left'){
			$content_class = 'gpx-2 gpr-lg-3 gpl-lg-0 gpt-2 gpt-md-6 gpb-2 gpb-md-4 text-center text-md-left';
		}

		$content_images = get_sub_field('field_'.$layout_prefix.'__content_images', $post_id);
	?>

	<div class="wpbc-full-aside-cols content-<?php echo $content_side; ?> break-lg">

		<div class="col-lg-6 p-0 col-fullside">
